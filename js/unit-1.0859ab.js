...
js6=new Plyr('.js6 audio',{'iconUrl':'css/plyr.svg',controls:['play','progress','current-time','mute','volume'],storage:{enabled:false}});
js6.volume=0.5;
js6.on('play',function(){plst('js6',function(){js6.pause();})});
js6.on('pause ended',function(){plrm('js6')});
initMenu($('#m2')[0]);
