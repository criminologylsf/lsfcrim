...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js39');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
var a='data-src';var e=document.querySelector('.js40');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');

var e=document.querySelector('.js33');e.setAttribute('src',(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
var e=document.querySelector('.js34');e.setAttribute('src',(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
var e=document.querySelector('.js35');e.setAttribute('src',(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
var e=document.querySelector('.js36');e.setAttribute('src',(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
var e=document.querySelector('.js37');e.setAttribute('src',(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
var e=document.querySelector('.js38');e.setAttribute('src',(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
initMenu($('#m10')[0]);
ldsrc('.js39');ldsrcset('.js41 source');ldsrc('.js40');ldsrcset('.js42 source');
});