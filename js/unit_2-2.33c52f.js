...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js29');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
var a='data-src';var e=document.querySelector('.js30');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');

var e=document.querySelector('.js23');e.setAttribute('src',(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
...
initMenu($('#m11')[0]);
ldsrc('.js29');ldsrcset('.js31 source');ldsrc('.js30');ldsrcset('.js32 source');
});