...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js22');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');

var e=document.querySelector('.js17');e.setAttribute('src',(dpi>1)?'images/pasted-image-36.png':'images/pasted-image-18.png');
...
ldsrc('.js22');ldsrcset('.js23 source');
});